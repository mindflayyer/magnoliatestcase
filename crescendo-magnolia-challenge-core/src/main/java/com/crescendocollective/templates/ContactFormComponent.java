...
import com.crescendocollective.mail.MailSender;
import com.crescendocollective.validators.ContactFormValidator;
...
public class ContactFormComponent {
    ...
    public String handleSubmit(@ModelAttribute ContactForm contactForm, BindingResult result, Node content) throws RepositoryException {
        ...
        MailSender mailSender = new MailSender(
                PropertyUtil.getString(content, "username", "testsmtp564@gmail.com"),
                PropertyUtil.getString(content, "password", "Test123456"),

                PropertyUtil.getString(content, "smtpServer", "smtp.gmail.com"),
                PropertyUtil.getString(content, "smtpPort", "587"),

                PropertyUtil.getString(content, "smtpAuth", "true"),
                PropertyUtil.getString(content, "smtpTlsEnabled", "true")
        );

        mailSender.sendEmail(contactForm.getEmail(), PropertyUtil.getString(content, "recipient", "testsmtp564@gmail.com"),
    ...
    public void contentTab(UiConfig cfg, TabBuilder tab) {
        tab.fields(
                ...
                cfg.fields.text("smtpServer").label("SMTP Server"),
                cfg.fields.text("smtpPort").label("SMTP Port"),

                cfg.fields.text("smtpAuth").label("Auth required"),
                cfg.fields.text("smtpTlsEnabled").label("Tls Enabled")
        );
    }
}
